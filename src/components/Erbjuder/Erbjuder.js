    ...
    <div className="erbjuder" id="erbjuder-cont">
      ...
      <div id="stada-dodsbo">
        ...
        <p>
          ...
          {city ? `i ${city}` : ""}? Vi på Trygga Dödsbon erbjuder en
      ...
      <div id="vardera-dodsbo">
        ...
        <p>
          ...
          {city ? `i ${city}` : ""}, kan vi på Trygga Dödsbon hjälpa dig. Vi
      ...
      <div id="uppkop-dodsbo">
        ...
        <p>
          Vi på Trygga Dödsbon är specialiserade på att köpa dödsbo{" "}
          {city ? `i ${city} ` : ""}
