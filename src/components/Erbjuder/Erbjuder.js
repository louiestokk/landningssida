    ...
    <div className="erbjuder" id="erbjuder-cont">
      ...
      <div id="stada-dodsbo">
        ...
        <p>
          ...
          {city ? `i ${city}` : ""}? Vi på Svenska Dödsbo erbjuder en
      ...
      <div id="vardera-dodsbo">
        ...
        <p>
          ...
          {city ? `i ${city}` : ""}, kan vi på Svenska Dödsbo hjälpa dig. Vi
      ...
      <div id="uppkop-dodsbo">
        ...
        <p>
          Vi på Svenska Dödsbo är specialiserade på att köpa dödsbo{" "}
          {city ? `i ${city} ` : ""}
