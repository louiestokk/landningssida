    ...
    <section>
      ...
      <Helmet>
        ...
        <link
          hrefLang="sv"
          rel="canonical"
          href="https://trygga-dodsbon.com/avfallshantering"
        />
      </Helmet>
      <div className="Nav">
        <Nav />
      ...
      >
        ...
        <div style={{ marginTop: "2rem" }}>
          ...
          <section>
            <p style={{ fontSize: "0.95rem", margin: "0.2rem 0.5rem" }}>
              Vi på Trygga Dödsbon erbjuder professionell avfallshanteringstjänst
        ...
        <div style={{ marginTop: "2rem" }}>
          ...
          <p style={{ fontSize: "0.85rem", margin: "0.2rem 0.5rem" }}>
            Trygga Dödsbon är din bästa partner när det gäller avfallshantering.
            ...
            kemikalier och mediciner. Trygga Dödsbon kan hjälpa till att sortera,
            transportera och återvinna allt avfall på ett sätt som är säkert för
            miljön och människor. Vi på Trygga Dödsbon har de rätta verktygen och
