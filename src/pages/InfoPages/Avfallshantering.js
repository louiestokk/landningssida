    ...
    <section>
      ...
      >
        ...
        <div style={{ marginTop: "2rem" }}>
          ...
          <section>
            <p style={{ fontSize: "0.95rem", margin: "0.2rem 0.5rem" }}>
              Vi på Svenska Dödsbo erbjuder professionell avfallshanteringstjänst
        ...
        <div style={{ marginTop: "2rem" }}>
          ...
          <p style={{ fontSize: "0.85rem", margin: "0.2rem 0.5rem" }}>
            Svenska Dödsbo är din bästa partner när det gäller avfallshantering.
            ...
            kemikalier och mediciner. Svenska Dödsbo kan hjälpa till att sortera,
            transportera och återvinna allt avfall på ett sätt som är säkert för
            miljön och människor. Vi på Svenska Dödsbo har de rätta verktygen och
